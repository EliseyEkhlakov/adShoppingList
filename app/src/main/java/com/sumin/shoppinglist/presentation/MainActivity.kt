...
class MainActivity : AppCompatActivity(), ShopItemFragment.OnEditingFinishedListener {
    ...
    private fun setupRecyclerView() {
        ...
        shopListAapter = ShopListAdapter()
        rvShopList.adapter = shopListAapter
        with(rvShopList) {
    ...
    private fun setupSwipeListener(rvShopList: RecyclerView) {
        val callback = object : ItemTouchHelper.SimpleCallback(
            ...
            override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
                val item = shopListAapter.currentList[viewHolder.adapterPosition]
    ...
    private fun setupClickListener() {
        shopListAapter.onShopItemClickListener = {
            if(isOnePaneMode()) {
    ...
    private fun setupLongClickListener() {
        shopListAapter.onShopItemLongClickListener = {
